...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(16), __webpack_require__(44)(module)))
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(16), __webpack_require__(41)(module)))
...
const strictUriEncode = __webpack_require__(42);
const decodeComponent = __webpack_require__(43);
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    function makeChildElementSelector() {
      ...
      return function selectChildElement(childProps, forwardRef) {
        if (childProps !== lastChildProps || forwardRef !== lastForwardRef) {
          ...
          lastChildElement = external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(FinalWrappedComponent, _extends({}, childProps, {
            ref: forwardRef
          }));
        }
    ...
    function (_OuterBaseComponent) {
      ...
      _proto.render = function render() {
        ...
        return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(ContextToUse.Consumer, null, this.renderWrappedComponent);
      };
...
/* harmony default export */ var reduce_reducers_es = (function () {
...
var query_string = __webpack_require__(9);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reducer", function() { return src_reducer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "signout", function() { return src_signout; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "signin", function() { return src_signin; });
...
var actions = {
  ...
  signin: function signin(creds) {
    ...
    return function (dispatch, getState) {
      ...
      return new Promise(function (resolve, reject) {
        axios_default.a.post('' + config.url + config.token, Object.assign({
  ...
  signout: function signout() {
    ...
    return function (dispatch, getState) {
      ...
      return axios_default.a.delete('' + config.url + config.token, {
  ...
  sync: function sync(token) {
    ...
    return function (dispatch, getState) {
      ...
      return axios_default.a.get('' + config.url + config.token, {
...
function src_signout(settings) {
  settings = Object.assign({
    success: function success() {},
    failed: function failed() {}
  }, settings);
  return function (Component) {
    return connect_connect(function (state) {
      ...
      _class.prototype.render = function render() {
        ...
        var props = Object.assign({}, Object(lodash["omit"])(rest, ['dispatch']));
        props.disabled = false;
        props.disabled = oauth.authenticating || Object(lodash["get"])(oauth, 'user.profile') === null;
        props.onClick = Object(lodash["wrap"])(props.onClick, function (func, e) {
  ...
  return function (Component) {
    return connect_connect(function (state) {
      ...
      _class2.prototype.handleClick = function handleClick(e, provider) {
        ...
        dispatch(actions.start());
        this.listenPopup(window.open(url, name, query_string_default.a.stringify(settings.popup).replace(/&/g, ',')));
      };
      ...
      _class2.prototype.listenPopup = function listenPopup(popup) {
        ...
        if (popup.closed) {
          ...
          var listen = function listen() {
            var token = void 0;
            try {
              token = query_string_default.a.parse(popup.location.search.substr(1));
            } catch (e) {}
      ...
      _class2.prototype.render = function render() {
        ...
        var props = Object.assign({}, Object(lodash["omit"])(rest, ['dispatch', 'onCancel', 'onSuccess', 'onFailed']));
        props.disabled = oauth.authenticating || Object(lodash["get"])(oauth, 'user.profile') !== null;
        props.onClick = Object(lodash["wrap"])(props.onClick, function (func, e) {
          _this5.handleClick(e, provider);
          return func(e);
        });
        return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Component, src_extends({}, props, { provider: provider }));
      };
